...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light" >
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal">优质师资</h1>
...
<br><br>
  <table class="table table-hover">
    ...
    <s:iterator value="# request.allInfo">
      <tr>
        <td><s:property  value="teaid"></s:property></td>
        <td><s:property  value="teaname"></s:property></td>
        <td><s:property  value="teaphone"></s:property></td>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
  <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
    <div class="my-3 py-3">
          <h2 class="display-5">“主讲+辅导”双师模式</h2>
      <p class="lead">提供更好保障</p>
    </div>
    <div class="bg-white shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="assets/brand/5.png"></img></div>
  </div>
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
    <div class="my-3 p-3">
      <h2 class="display-5">六轮面试筛选主讲老师</h2>
      <p class="lead">无需担心质量</p>
    </div>
    <div class="bg-white shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="assets/brand/6.png"></img></div>
   </div>
</div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
  <div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
    <div class="my-3 p-3">
      <h2 class="display-5">丰富教学经验</h2>
      <p class="lead">沉淀好方法</p>
    </div>
    <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="assets/brand/4.png"></img></div>
  </div>
  <div class="bg-primary mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
    <div class="my-3 py-3">
      <h2 class="display-5">专业全程辅导</h2>
      <p class="lead">无需再忧心</p>
    </div>
    <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="assets/brand/2.png"></img></div>
  </div>
</div>
